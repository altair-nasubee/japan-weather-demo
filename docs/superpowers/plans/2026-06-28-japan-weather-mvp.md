...
- [ ] **Step 1: FreeCameraController を実装**
...
- [ ] **Step 5: 生成スクリプト（CitiesJsonGenerator）を実装**
...
- [ ] **Step 6: CSV を取り込み Cities.json を生成**
...
- [ ] **Step 1: ApiKeyResolver の失敗するテストを書く**
...
- [ ] **Step 6: config.example.json と .gitignore**
...
- [ ] **Step 7: コンパイル確認（WeatherService は Play Mode 統合で後検証）**
...
- [ ] **Step 3: SnapshotInterpolator を実装**
...
- [ ] **Step 1: PrecipitationController を実装**
...
- [ ] **Step 1: WeatherTimelineSO のテストを追加（失敗を確認）**
...
- [ ] **Step 2: WeatherTimelineSO に SetContinuousIndex を実装**
...
- [ ] **Step 4: TimelineUIController を実装**
...
- [ ] **Step 5: GameManager から UI 再設定を呼ぶ（Modify）**
...
- [ ] **Step 1: InfoPanelController を実装**
...
- [ ] **Step 1: GameManager に LoadingChanged を追加（Modify）**
...
- [ ] **Step 3: ローディングスピナーを実装（Modify or 小コンポーネント）**
